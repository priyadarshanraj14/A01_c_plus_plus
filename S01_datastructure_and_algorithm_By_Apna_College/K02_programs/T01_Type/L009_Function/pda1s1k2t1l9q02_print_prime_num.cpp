//(L9) Function /(Q2):- print all the prime number between two given numbers?
#include<iostream>
...
{
    int a,b; 
    cout<<"enter the range of number from a to b to find all prime number in between them a=";
    cin>>a;
    cout<<"b=";
    cin>>b; 
    for(int i=a;i<=b;i++)
